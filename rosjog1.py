...
def joint_states_callback(msg):
    ...
    try:
        ...
        joint1_degrees = float(input("Enter Joint 1:"))
        joint1_degrees = math.degrees(joint1_degrees)
        joint2_degrees = float(input("Enter Joint 2:"))
        joint2_degrees = math.degrees(joint2_degrees)
        joint3_degrees = float(input("Enter Joint 3:"))
        joint3_degrees = math.degrees(joint3_degrees)
        joint4_degrees = float(input("Enter Joint 4:"))
        joint4_degrees = math.degrees(joint4_degrees)
        joint5_degrees = float(input("Enter Joint 5:"))
        joint5_degrees = math.degrees(joint5_degrees)
        joint6_degrees = float(input("Enter Joint 6:"))
        joint6_degrees = math.degrees(joint6_degrees)
        
        #joint2_degrees = math.degrees(0.15936500569557888)
        #joint3_degrees = math.degrees(-0.2932024688474439)
        #joint4_degrees = math.degrees(-0.7767875203810728)
        #joint5_degrees = math.degrees(0.5984212683206187)
        #joint6_degrees = math.degrees(0.2052249387260856)
