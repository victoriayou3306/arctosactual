...
WAYPOINTS = [
    # (  x,     y,     z,    qx,   qy,   qz,   qw  )
    (  0.4,  -0.31,  0.2032,  0.0,  0.0,  0.0,  1.0 ),  # Point 1
    (  0.3,  -0.31,  0.2032,  0.0,  0.0,  0.0,  1.0 ),  # Point 2
    (  0.2,  -0.31,  0.2032,  0.0,  0.0,  0.0,  1.0 ),  # Point 3
    (  0.2,  -0.21,  0.2032,  0.0,  0.0,  0.0,  1.0 ),  # Point 4 — back to start Z
]
